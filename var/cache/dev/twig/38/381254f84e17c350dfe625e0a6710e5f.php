...
class __TwigTemplate_cf684980bfa549839c18af8deb9770d9 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 2, $this->source); })()), "title", [], "any", false, false, false, 2), "html", null, true);
    ...
    public function block_description($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "description", [], "any", false, false, false, 6), "html", null, true);
    ...
    public function block_fbdescription($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 7, $this->source); })()), "description", [], "any", false, false, false, 7), "html", null, true);
    ...
    public function block_twdescription($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 8, $this->source); })()), "description", [], "any", false, false, false, 8), "html", null, true);
    ...
    public function block_ogdescription($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "description", [], "any", false, false, false, 9), "html", null, true);
    ...
    public function block_fbimage($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 10, $this->source); })()), "cover", [], "any", false, false, false, 10), "html", null, true);
    ...
    public function block_twimage($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 11, $this->source); })()), "cover", [], "any", false, false, false, 11), "html", null, true);
...
<h1 class=\"text-center\"><strong><a href=\"/article/\">";
        // line 14
...
<img class=\"img-fluid \" alt=\"";
        ...
        echo "\" src=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 15, $this->source); })()), "cover", [], "any", false, false, false, 15), "html", null, true);
        echo "\"/>
<h3>";
        // line 16
...
<p>";
        // line 17
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 17, $this->source); })()), "content", [], "any", false, false, false, 17), "html", null, true);
        echo "</p>
</div>
...
";
    ...
    {
        return array (  291 => 20,  285 => 17,  281 => 16,  275 => 15,  271 => 14,  268 => 13,  258 => 12,  239 => 11,  220 => 10,  201 => 9,  182 => 8,  163 => 7,  144 => 6,  125 => 5,  106 => 4,  87 => 3,  68 => 2,  45 => 1,);
    }
...
{% block fbtitle %}{{ article.title }}{% endblock %}
{% block twtitle %}{{ article.title }}{% endblock %}
{% block ogtitle %}{{ article.title }}{% endblock %}
{% block description %}{{ article.description }}{% endblock %}
{% block fbdescription %}{{ article.description }}{% endblock %}
{% block twdescription %}{{ article.description }}{% endblock %}
{% block ogdescription %}{{ article.description }}{% endblock %}
{% block fbimage%}{{ article.cover}}{% endblock %}
{% block twimage%}{{ article.cover}}{% endblock %}
{% block body %}
<div class=\"col-12 p-3 p-md-5\">
<h1 class=\"text-center\"><strong><a href=\"/article/\">{{ article.title }}</a></strong></h1>
<img class=\"img-fluid \" alt=\"{{ article.title }}\" src=\"{{ article.cover }}\"/>
<h3>{{ article.description }}</h3>
<p>{{ article.content }}</p>
</div>
<div class=\"p-1 text-center\">
<a class=\"btn btn-dark text-white\" href=\"{{ path('article_index') }}\">back to article</a>
</div>
{% endblock %}
", "article/show.html.twig", "/home/user/Bureau/atmproject/symsocial/blogcms/templates/article/show.html.twig");
    }
}
